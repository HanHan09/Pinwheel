...
**权限使用目的说明：** 调用设备的拍照功能，用拍的照片作为事件的背景，需要相机权限，将在具体场景下触发授权               
**权限授权方式：** 应用首页->右上角“+”图标->事件创建页面               
**是否可关闭：** 是             
...
*  **6）权限名称：** 读取设备上的照片(android.permission.READ_MEDIA_IMAGES）              
**权限使用目的说明:**  读取设备上的图片，作为事件的背景，，需要相机权限，读取设备上的照片权限，将在具体场景下触发授权            
**权限授权方式：** 应用首页->右上角“+”图标->事件创建页面                 
**是否可关闭：** 是 
